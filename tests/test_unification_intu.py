...
def prefixes():
    syms = {
        "ABC": Function("string", [Variable("A"), Variable("B"), Variable("C")]),
        "abc": Function("string", [Function("a"), Function("b"), Function("c")]),
        "ABCD": Function(
            "string", [Variable("A"), Variable("B"), Variable("C"), Variable("D")]
        ),
        "abcd": Function(
            "string", [Function("a"), Function("b"), Function("c"), Function("d")]
        ),
        "AbCdE": Function(
            "string",
            [Variable("A"), Function("b"), Variable("C"), Function("d"), Variable("E")],
        ),
        "aBcDe": Function(
            "string",
            [Function("a"), Variable("B"), Function("c"), Variable("D"), Function("e")],
        ),
        "aBCDE": Function(
            "string",
            [Function("a"), Variable("B"), Variable("C"), Variable("D"), Variable("E")],
        ),
        "aBFGH": Function(
            "string",
            [Function("a"), Variable("B"), Variable("F"), Variable("G"), Variable("H")],
        ),
    }
    yield syms
...
def substitutions(prefixes):
    unify = {}
    unify["all_1"], _ = pre_unify_all(
        prefixes["ABC"].args, [], prefixes["abc"].args, unifiers=[]
    )
    unify["all_2"], _ = pre_unify_all(
        prefixes["ABCD"].args, [], prefixes["abcd"].args, unifiers=[]
    )
    unify["all_3"], _ = pre_unify_all(
        prefixes["AbCdE"].args, [], prefixes["aBcDe"].args, unifiers=[]
    )
    unify["all_4"], _ = pre_unify_all(
        prefixes["aBCDE"].args, [], prefixes["aBFGH"].args, unifiers=[]
    )
    ...
    equations = [
        (prefixes["ABC"], prefixes["abc"]),
        (prefixes["ABCD"], prefixes["abcd"]),
    ]
...
class TestPreUnify:
    def test_flatten(self):
        ...
        b = Function(
            "string",
            [Function("c_skolem", [Variable("X"), Function("string", [a])]), a],
        )
    ...
    def test_prefix_unification_list3(self):
        ...
        cw1 = Function(
            "string", args=[Function("c_skolem", args=[Constant("14")]), Variable("W1")]
        )
        z = Function("string", args=[Variable("Z")])
        ab = Function("string", args=[Variable("A"), Variable("B")])
        zc = Function(
            "string", args=[Variable("Z"), Function("c_skolem", args=[Constant("7")])]
        )
