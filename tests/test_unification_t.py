...
def prefixes():
    syms = {
        ...
        "EFGH": Function(
            "string", [Variable("E"), Variable("F"), Variable("G"), Variable("H")]
        ),
        "AbCd": Function(
            "string", [Variable("A"), Function("b"), Variable("C"), Function("d")]
        ),
        "eFgH": Function(
            "string", [Function("e"), Variable("F"), Function("g"), Variable("H")]
        ),
        "left": Function(
            "string",
            [
                Function(
                    "c_skolem", [Function("1"), Function("c_skolem", [Function("2")])]
                )
            ],
        ),
        "right": Function(
            "string", [Function("c_skolem", [Function("1"), Variable("_76862")])]
        ),
    }
    yield syms
...
def substitutions(prefixes):
    ...
    unify["all_1"], _ = pre_unify_all(
        prefixes["ABCD"].args, [], prefixes["ab"].args, unifiers=[]
    )
    unify["all_2"], _ = pre_unify_all(
        prefixes["ABCD"].args, [], prefixes["abc"].args, unifiers=[]
    )
    unify["all_3"], _ = pre_unify_all(
        prefixes["AbCd"].args, [], prefixes["eFgH"].args, unifiers=[]
    )
    unify["all_first_1"], _ = pre_unify_all(
        prefixes["ABC"].args, [], prefixes["EFG"].args, unifiers=[]
    )
    unify["all_first_2"], _ = pre_unify_all(
        prefixes["ABCD"].args, [], prefixes["EFGH"].args, unifiers=[]
    )
    yield unify
